...
<h1>Available Phases</h1>
     <%
         ...
         ArrayList tempList = (ArrayList)phases.getGlobalInflow();
     ...
     <blockquote>
         ...
         <blockquote>
         <%
             tempList = (ArrayList)phases.getGlobalInFaultPhases();
             for (int i = 0; i < tempList.size(); i++) {
                 Phase phase = (Phase) tempList.get(i);
         %><%=phase.getPhaseName()%><br><%
             }
         ...
         <blockquote>
         <%
             tempList = (ArrayList)phases.getGlobalOutPhaseList();
             for (int i = 0; i < tempList.size(); i++) {
                 Phase phase = (Phase) tempList.get(i);
         %><%=phase.getPhaseName()%><br><%
             }
         ...
         <blockquote>
         <%
             tempList = (ArrayList)phases.getOUT_FaultPhases();
             for (int i = 0; i < tempList.size(); i++) {
                 Phase phase = (Phase) tempList.get(i);
         %><%=phase.getPhaseName()%><br><%
             }
         ...
         <blockquote>
         <%
             tempList =(ArrayList) phases.getOperationInFaultPhases();
             for (int i = 0; i < tempList.size(); i++) {
                 Phase phase = (Phase) tempList.get(i);
         %><%=phase.getPhaseName()%><br><%
             }
